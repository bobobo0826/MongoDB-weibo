...
class Spider(CrawlSpider):
    ...
    def start_requests(self):
        while self.scrawl_ID.__len__():
            ID = self.scrawl_ID.pop()#删除列表中的指定对象（如果没有指定对象，默认是最后一个值）,返回要删除元素的值
    ...
    def parse3(self, response):
        ...
        #     u'body//table/tr/td/a[contains(text(),"关注他")]/@href').extract()
        #法二
        text2 = selector.xpath(
            u'body//table/tr/td/a[text()="\u5173\u6ce8\u4ed6" or text()="\u5173\u6ce8\u5979"]/@href').extract()#关注他、关注她
        #法三
        # text2 = selector.xpath(
        ...
        url_next = selector.xpath(
            u'body//div[@class="pa" and @id="pagelist"]/form/div/a[text()="\u4e0b\u9875"]/@href').extract()#下页
        if url_next:
